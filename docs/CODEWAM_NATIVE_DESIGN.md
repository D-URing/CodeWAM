...
E6: future code -> stage/success/contact proxy
```
...
- 做 state token/dynamics/frozen tokenizer/source ablation。
...
第一阶段重点: anti-proprio-shortcut + action-conditioned code dynamics.
